...
const CONTENT = {
  ...
  // ---- Phase 2: accounts & organisations copy ----------------------
  nav: {
    home: "Home",
  ...
  auth: {
    ...
    fillBoth: "Please enter your email and password.",
    genericError: "Something went wrong. Please try again.",
    login: {
      title: "Sign in",
      body: "Sign in to see your history and keep your profiles together.",
      cta: "Sign in",
      working: "Signing in…",
      forgot: "Forgotten your password?",
      noAccount: "New to Conversa?",
      registerLink: "Create an account",
    },
    register: {
      title: "Create your account",
      body: "It takes a moment. You'll get your own space to keep your communication profiles.",
      cta: "Create account",
      working: "Creating your account…",
      passwordHint: "At least 6 characters.",
      passwordTooShort: "Please use a password of at least 6 characters.",
    ...
    reset: {
      ...
      dormantNote:
        "Note: password-reset emails aren't switched on yet, so a message may not arrive. This will start working once email is configured.",
      cta: "Send reset link",
      working: "Sending…",
      ...
      setBody: "Choose a new password for your account.",
  ...
  organisation: {
    title: "Organisation",
    subtitle: "A snapshot of your organisation. You only see your own organisation's data.",
    internalNotice:
      "For internal use. Conversa is an educational communication aid, not a diagnostic or performance tool — please don't use anything here for hiring, promotion, performance or disciplinary decisions.",
    noOrgBody:
      "You're currently in your personal workspace, so there's no team dashboard to show. Create an organisation, or switch to one you administer, from your account.",
    toAccountCta: "Go to your account",
    statUsers: "Users",
    statProfiles: "Communication profiles",
    statPressure: "Under-pressure profiles",
    statLast: "Last activity",
    recentHeading: "Recent activity",
    noActivity: "No communication profiles completed in this organisation yet.",
    usersHeading: "Users",
  ...
  account: {
    ...
    orgsHeading: "Your organisations",
    orgsEmpty: "You're not in any organisations yet.",
    activeTag: "Active",
    switchCta: "Switch to this",
    openDashboard: "Open dashboard",
    createLabel: "Create a new organisation",
    createPlaceholder: "e.g. EBI Ltd",
    createCta: "Create",
    roleOrgAdmin: "Administrator",
    roleMember: "Member",
    activityHeading: "Your activity",
    statReflections: "Communication profiles",
    statPressure: "Under-pressure profiles",
    statLast: "Last activity",
    startCta: "Start a new communication profile →",
    historyHeading: "Your history",
    historyEmpty: "You haven't completed a communication profile yet.",
    colDate: "Date",
    colType: "Type",
    colStyle: "Communication style",
    colScores: "Drive / Connection / Clarity",
    typeEveryday: "Everyday",
    typePressure: "Under pressure",
    patternLabels: {
      FOCUSED: "Focused",
    ...
    email: "Email",
    emailHint: "Contact us to change the email on your account.",
    company: "Company",
    jobTitle: "Job title",
    country: "Country",
    ...
    detailsFailed: "Couldn't save your details. Please try again.",
    passwordHeading: "Password",
    newPassword: "New password",
    changePassword: "Change password",
    passwordTooShort: "Please use a password of at least 6 characters.",
    passwordChanged: "Your password has been changed.",
    passwordFailed: "Couldn't change your password. Please sign in again.",
    loadFailed: "We couldn't load your account just now. Please refresh.",
  },
  ...
  admin: {
    ...
    platform: {
      ...
      statEveryday: "Communication profiles",
      statPressure: "Under-pressure profiles",
      newestHeading: "Newest organisations",
      topHeading: "Most active organisations",
      usersHeading: "Users",
      orgsHeading: "Organisations",
      userSearch: "Search users by name or email",
      orgSearch: "Search organisations by name",
      colName: "Name",
      colEmail: "Email",
      colJoined: "Joined",
      colOrg: "Organisation",
      colCreated: "Created",
      noOrgs: "No organisations yet.",
